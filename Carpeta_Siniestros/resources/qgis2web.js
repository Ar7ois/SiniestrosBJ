...
map.getView().fit([-11049219.842690, 2194337.989746, -11028961.082433, 2204808.680170], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de siniestros viales en la Alcaldía Benito Juárez_2023</h2>';
        return titleElement;
    })(),
